    ...
    spec:
      containers:
        - name: stage-ti-backend
          ...
          envFrom:
          - secretRef:
             name: stage-ti-backend-secret
          - configMapRef:
             name: stage-ti-backend-configmap
          env:
      ...
      - name: gcp-sa-key
        secret:
          secretName: stage-ti-backend-gcp-sa-secret
     # volumes:
     # - name: firebase-sa-key
     #   secret:
     #     secretName: stage-ti-backend-firebase-sa-secret
